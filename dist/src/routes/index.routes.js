...
var review_schema_1 = require("../../schemas/review.schema");
...
router.post('/review', (0, schemaValidation_1.default)(review_schema_1.createReviewSchema), review_controller_1.default.createReview);
router.get('/review/person/:id', review_controller_1.default.readReviews);
