        ...
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 1:
                    ...
                    return [4 /*yield*/, person_repository_1.default.findPersonById(id)];
                case 2:
                    randomPerson = _b.sent();
                    _b.label = 3;
                case 3:
                    if (!(randomPerson.rowCount === 0 && amountOfPeople > 0)) return [3 /*break*/, 5];
                    id = Math.floor(Math.random() * (maxId - 1 + 1) + 1);
                    return [4 /*yield*/, person_repository_1.default.findPersonById(id)];
                case 4:
                    randomPerson = _b.sent();
                    return [3 /*break*/, 3];
                case 5: return [2 /*return*/, randomPerson.rows[0]];
            }
        });
    });
}
